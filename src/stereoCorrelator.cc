...
StereoCorrelator::StereoCorrelator(const std::string &leftImagePath,
...
void StereoCorrelator::calculateDisparityMap()
{
    ...
    GDALDataset *leftImageDataset = static_cast<GDALDataset *>(GDALOpen(leftImagePath.c_str(), GA_ReadOnly));
    GDALDataset *rightImageDataset = static_cast<GDALDataset *>(GDALOpen(rightImagePath.c_str(), GA_ReadOnly));
